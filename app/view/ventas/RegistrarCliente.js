Ext.define('tiendarepuestos.view.ventas.RegistrarCliente', {
    ...
    initComponent: function() {
        var storeTipoDoc = Ext.create('tiendarepuestos.store.TipoDocumentos');
        me = this;
        Ext.apply(me, {
            items: [
                {
                    ...
                    url : tiendarepuestos.util.Rutas.clienteGuardar,
                    bodyPadding: 5,
                    layout: {
                        type: 'hbox',
                        align: 'stretch'
