Ext.define('tiendarepuestos.view.ventas.EditarCotizacion', {
    ...
    initComponent: function () {
        ...
        //var storeDetCot = Ext.create('tiendarepuestos.store.CotizacionesDetalle');
        ...
        Ext.applyIf(me, {
            items: [{
                    ...
                    url: tiendarepuestos.util.Rutas.cotizacionGuardar,
                    items: [{
                            xtype: 'panel',
                            flex: 1,
                            frame: false,
                            ...
                            items: [{
                                ...
                                },
                                {
                                    ...
                                    buttons: [{
                                            ...
                                            text: 'Cancelar',
                                            scale: 'medium',
                                            glyph: tiendarepuestos.util.Glyphs.getGlyph('cancelar'),
