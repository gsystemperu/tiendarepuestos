Ext.define('tiendarepuestos.view.ventas.GuiaRemision', {
    ...
    requires: [
        ...
        'tiendarepuestos.view.ventas.AccionesGuiaRemision'
    ],
    itemId: 'wGuiaRemision',
    controller: 'acciones-guiaremision',
    initComponent: function () {
        me = this;
        __storeGuiaRemisionDetalle = Ext.create('tiendarepuestos.store.GuiaRemisionDetalle');
        __storeMotivosTranslado = Ext.create('tiendarepuestos.store.MotivosTranslados');
        Ext.applyIf(me, {
            items: [
                {
                    xtype: "form",
                    ...
                    url: tiendarepuestos.util.Rutas.guiaRemisionActualizar,
                    items: [
                        {
                            xtype: 'panel',
                            border: false,
