Ext.define('tiendarepuestos.view.ventas.Mantenimiento', {
    ...
    requires: [
        ...
        'Ext.toolbar.Toolbar',
        'Ext.form.Panel',
        'tiendarepuestos.view.ventas.AccionesMantenimiento'
    ],
    autoShow: true,
    width: 900,
    height: 400,
    ...
    getItems: function () {
        var storeUM = Ext.create('tiendarepuestos.store.UnidadMedida');
        var storeME = Ext.create('tiendarepuestos.store.ModoEntrega');
        var storeFP = Ext.create('tiendarepuestos.store.FormaPago');
        var storeVE = Ext.create('tiendarepuestos.store.Vendedores');
        var storePR = Ext.create('tiendarepuestos.store.Presentacion');
        var storeCA = Ext.create('tiendarepuestos.store.Categoria');
        ...
        var _obj = [{
            ...
            items: [{
                ...
                },
                {
                    ...
                    items: [{
                            xtype: 'form',
                            url: tiendarepuestos.util.Rutas.vendedorGuardar,
