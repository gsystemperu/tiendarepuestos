Ext.define('tiendarepuestos.view.ventas.AccionesContenedorClientes', {
    ...
    onClickImprimirCC:function(){
      ...
      if (_record) {
          ...
          var objrpt = window.open( tiendarepuestos.util.Rutas.rptClienteImprimirPagosCC+ 'idper='+ __id+"&persona="+__nombre, "", "width=700,height=900");
    ...
    onClickImprimirListadoCC:function(){
      ...
      if (_record) {
          __nombre = _record.get('nombreper');
          __id     = _record.get('idper');
          var objrpt = window.open( tiendarepuestos.util.Rutas.rptClienteImprimirCC+ 'idper='+ __id+"&persona="+__nombre, "", "width=700,height=900");
          //setTimeout(function(){ objrpt.close(); }, 1000);
      } else {
          Ext.Msg.alert("Aviso", "Seleccionar al cliente para imprimir");
          return false;
