Ext.define('tiendarepuestos.view.ventas.AccionesContenedorCotizacionesFacturar', {
    ...
    onClickDocumentoImprimir:function(btn){
      try {
          ...
          //if(_record.get('idguia')>0){
            ...
            var objrpt = window.open( tiendarepuestos.util.Rutas.rptImprimirNota+ 'id='+ _record.get('idfacturacion'), "", "width=700,height=900");
    ...
    onClickGuiasRemisionImpresion:function(btn){
      try {
          var _record =  Ext.ComponentQuery.query('#dgvVentasFacturar')[0].getSelectionModel().getSelection()[0];
          if(_record.get('idguia')>0){
            var objrpt = window.open( tiendarepuestos.util.Rutas.rptImprimirGuiaRemision+
      ...
      try {
             ...
             _record.get('idguia') == 0 )
        {
          ...
          if(_record.get('idfacturacion')==0){
            ...
            Ext.Ajax.request({
              url : (_record.get('idfacturacion')==0?tiendarepuestos.util.Rutas.cotizacionDetalle:tiendarepuestos.util.Rutas.facturacionDetalle),
              params:{
                vIdCotizacion : _record.get('idcoti')
              },
              method : 'GET',
