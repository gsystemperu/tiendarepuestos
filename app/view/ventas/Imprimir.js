Ext.define('tiendarepuestos.view.ventas.Imprimir', {
    ...
    getItems:function(){
      var storeOrientacion = Ext.create('tiendarepuestos.store.PosicionReporte');
      var storeFormato     = Ext.create('tiendarepuestos.store.FormatoReporte');
      var storeFirmas     = Ext.create('tiendarepuestos.store.Firmas');
