Ext.define('tiendarepuestos.view.ventas.BuscarProductoFB', {
    extend: 'Ext.window.Window',
    alias: 'widget.wBuscarProductoFB',
    xtype: 'wBuscarProductoFB',
    requires: [
      'tiendarepuestos.view.ventas.AccionesRegFacturaBoleta'
    ],
    config : {
      cliente : 0,
      detalle : null
    ...
    initComponent: function () {
        var store = Ext.create('tiendarepuestos.store.ProductosPorPrecioPersona');
        me        = this;
