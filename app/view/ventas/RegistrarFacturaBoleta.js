Ext.define('tiendarepuestos.view.ventas.RegistrarFacturaBoleta', {
    ...
    initComponent: function () {
        ...
        var storeClientes = Ext.create('tiendarepuestos.store.Clientes');
        var storeProductos = Ext.create('tiendarepuestos.store.Productos');
        var storeDetCotizacion = Ext.create('tiendarepuestos.store.DetalleCotizacion');
        ...
        var storeVendedores = Ext.create('tiendarepuestos.store.Vendedores');
        var storeMonedas = Ext.create('tiendarepuestos.store.Monedas');
        var storeDocumentoVenta = Ext.create('tiendarepuestos.store.DocumentoVenta');
        ...
        Ext.applyIf(me, {
            items: [{
                    ...
                    padding : 10,
                    url: tiendarepuestos.util.Rutas.facturacionGuardar,
                    items: [{
                            xtype: 'panel',
                            flex: 1,
                            frame: false,
