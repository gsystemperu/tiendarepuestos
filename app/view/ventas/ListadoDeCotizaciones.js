Ext.define('tiendarepuestos.view.ventas.ListadoDeCotizaciones', {
    ...
    initComponent: function () {
        var storeCoti    = Ext.create('tiendarepuestos.store.Cotizaciones');
        var storeCotiDet = Ext.create('tiendarepuestos.store.CotizacionesDetalle');
        var storeEstado = Ext.create('tiendarepuestos.store.BusquedaEstado');
