...
Ext.define('tiendarepuestos.view.seguridad.Usuarios',{
    extend: 'Ext.panel.Panel',
    xtype : 'wusuarios',
    requires: [
        'tiendarepuestos.view.seguridad.UsuariosController',
        'tiendarepuestos.view.seguridad.UsuariosModel'
    ],
    ...
    requires: [
      ...
      'tiendarepuestos.view.almacen.AccionesProveedor',
      'Ext.grid.*',
      ...
      Ext.apply(this, {
        items: [{
            ...
            items: [{
              ...
              url: tiendarepuestos.util.Rutas.proveedorGuardar,
              defaults:{
                xtype:'textfield'
              },
