Ext.define('tiendarepuestos.view.conf.configNuevaTicketera', { //**CAMBIAR
        extend: 'Ext.panel.Panel',
        xtype: 'wnuevaticketera', //**CAMBIAR
        alias: 'widget.wnuevaticketera', //**CAMBIAR
        requires: [
            'Ext.layout.container.HBox',
            'tiendarepuestos.view.conf.configNuevaTicketeraController',
            'Ext.grid.*',
            'Ext.grid.column.*',
            'Ext.form.field.*'
        ],
        ...
        initComponent: function () {
            st = Ext.create('tiendarepuestos.store.TiendaTicketerasAsignadas');
            d  = Ext.create('tiendarepuestos.store.TiendaTicketeras');
