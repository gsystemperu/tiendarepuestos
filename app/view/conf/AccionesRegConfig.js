...
Ext.define('tiendarepuestos.view.conf.AccionesRegConfig', {
    ...
    onClickEliminarBanco:function(btn){
        me = this;
        Ext.Ajax.request({
                url: tiendarepuestos.util.Rutas.bancoEliminar,
    ...
    onSelectedCategoria : function( grid, record, index, eOpts ) {this.lookupReference('frmCategoria').loadRecord(record)},
     ...
     onClickEliminarCategoria:function(btn){
        me = this;
        Ext.Ajax.request({
                url: tiendarepuestos.util.Rutas.categoriaEliminar,
                params: { id          : btn.getWidgetRecord().get('id')},
                success: function(response){
                    var _error = Ext.JSON.decode(response.responseText);
                    if(_error.error!=0){
    ...
    onClickEliminarColor:function(btn){
         me = this;
        Ext.Ajax.request({
                url: tiendarepuestos.util.Rutas.colorEliminar,
                params: { id          : btn.getWidgetRecord().get('id')},
                success: function(response){
                    var _error = Ext.JSON.decode(response.responseText);
                    if(_error.error!=0){
    ...
    onClickEliminarMedida:function(btn){
         me = this;
        Ext.Ajax.request({
                url: tiendarepuestos.util.Rutas.medidaEliminar,
                params: { id          : btn.getWidgetRecord().get('id')},
                success: function(response){
                    var _error = Ext.JSON.decode(response.responseText);
                    if(_error.error!=0){
    ...
    onClickEliminarUnidadMedida:function(btn){
          ...
          me = this;
        Ext.Ajax.request({
                url: tiendarepuestos.util.Rutas.unidadMedidaEliminar,
                params: { id          : btn.getWidgetRecord().get('id')},
                success: function(response){
                    var _error = Ext.JSON.decode(response.responseText);
                    if(_error.error!=0){
    ...
    onClickEliminarTipoProducto:function(btn){
          me = this;
        Ext.Ajax.request({
                url: tiendarepuestos.util.Rutas.tipoProductoEliminar,
                params: { id          : btn.getWidgetRecord().get('id')},
                success: function(response){
                    var _error = Ext.JSON.decode(response.responseText);
                    if(_error.error!=0){
    ...
    onClickEliminarPresentacion:function(button){
      var rec = button.getWidgetRecord();
          if (rec) {
             Ext.Ajax.request({
                 url :tiendarepuestos.util.Rutas.presentacionEliminar,
                 params:{
    ...
    onClickEliminarFormaPago:function(button){
      ...
      if (rec) {
             Ext.Ajax.request({
                 url :tiendarepuestos.util.Rutas.formaPagoEliminar,
                 params:{
    ...
    onClickEliminarModoEntrega:function(button){
      var rec = button.getWidgetRecord();
        if (rec) {
             Ext.Ajax.request({
                 url :tiendarepuestos.util.Rutas.modoEntregaEliminar,
                 params:{
    ...
    onClickEliminarMarca:function(btn){
        me = this;
        Ext.Ajax.request({
                url: tiendarepuestos.util.Rutas.marcaEliminar,
                params: { id          : btn.getWidgetRecord().get('id')},
                success: function(response){
                    var _error = Ext.JSON.decode(response.responseText);
                    if(_error.error!=0){
    ...
    onClickEliminarModelo:function(btn){
        me = this;
        Ext.Ajax.request({
                url: tiendarepuestos.util.Rutas.modeloEliminar,
                params: { id          : btn.getWidgetRecord().get('id')},
                success: function(response){
                    var _error = Ext.JSON.decode(response.responseText);
                    if(_error.error!=0){
