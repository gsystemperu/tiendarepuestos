Ext.define('tiendarepuestos.view.almacen.IngresarAbastecimiento', {
    extend: 'Ext.window.Window',
    xtype: 'wingresarabastecimiento',
    requires: [
        'Ext.grid.plugin.*',
        'tiendarepuestos.view.almacen.AccionesReglasAbastecimiento',
    ...
    initComponent: function () {
        ...
        var storeTipoDoc      = Ext.create('tiendarepuestos.store.TipoDocumento');
        var storeProveedores = Ext.create('tiendarepuestos.store.Proveedores');
        var storeDetalle      = Ext.create('tiendarepuestos.store.DetalleAbastecimiento');
        me = this;
        Ext.applyIf(me, {
            items: [{
                    xtype: "form",
                    ...
                    url: tiendarepuestos.util.Rutas.abastecimientoGuardar,
                    items: [{
                            xtype: 'panel',
                            flex: 1,
                            frame: false,
