Ext.define('tiendarepuestos.view.almacen.ListadoInventario',{
    extend: 'Ext.panel.Panel',
    xtype: 'wListadoInventario',
    alias: 'widget.wListadoInventario',
    requires: [
      'Ext.layout.container.HBox',
      'tiendarepuestos.view.almacen.ListadoInventarioController',
      'Ext.grid.*',
      'Ext.form.field.*',
      'Ext.grid.plugin.*'
    ],
    ...
    initComponent: function () {
      var st = Ext.create('tiendarepuestos.store.InventarioRegistros');
