Ext.define('tiendarepuestos.view.almacen.ContenedorInventarioController', {
    ...
    onClickEditarInventario: function (btn) {
        try {
            ...
            if(r){
                ...
                {
                    tiendarepuestos.util.Util.showToast('El inventario no se puede modificar esta validado.');
                    return false;
                }
                me = Ext.ComponentQuery.query('#wContenedorInventario')[0];    //this;
                l = me.getLayout();
                ...
                tiendarepuestos.util.Util.showToast('Seleccionar el registro a editar!');
            }
    ...
    onClickImprimirStockInventario: function (btn) {
        w = window.open(tiendarepuestos.util.Rutas.inventarioImprimirStock, "", "width=700,height=900");
    ...
    onClickConfirmarInventario:function(btn){
        ...
        if (f.isValid()) {
            ...
            console.log(JSON.stringify(d));
             f.submit({
                ...
                success: function (form, action) {
                    ...
                    tiendarepuestos.util.Util.showToast('Inventario Guardado!');
                    Ext.ComponentQuery.query('#btnConfInventario')[0].setHidden(true);
            ...
            tiendarepuestos.util.Util.showErrorMsg('Ingresar los datos para el inventario!');
        }
    }
