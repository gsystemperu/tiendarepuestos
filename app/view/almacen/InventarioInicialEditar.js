Ext.define('tiendarepuestos.view.almacen.InventarioInicialEditar', {
    ...
    requires: [
        ...
        'tiendarepuestos.view.almacen.InventarioInicialEditarController',
        'tiendarepuestos.view.almacen.InventarioInicialEditarModel',
    ...
    url: tiendarepuestos.util.Rutas.inventarioAgregar,
    ...
    initComponent: function () {
        var st = Ext.create('tiendarepuestos.store.ProductoInventarioLista');
