...
Ext.define('tiendarepuestos.view.almacen.AccionesReglasAbastecimiento', {
    ...
    onClickIngresar:function(){
        Ext.create('tiendarepuestos.view.almacen.IngresarAbastecimiento');
    },
    onClickBuscarProducto:function(btn){
        Ext.create('tiendarepuestos.view.almacen.ProductoBuscar');
    },
    ...
    onClickFormularioProveedor :function(btn){
        var win   = Ext.create('tiendarepuestos.view.almacen.FormProveedor',{control: btn.control.toString()});
    },
