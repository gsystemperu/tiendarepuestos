Ext.define('tiendarepuestos.view.almacen.ProductoBuscar', {
    ...
    initComponent:function(){
        me = this;
        storeProducto  = Ext.create('tiendarepuestos.store.Productos');
        storeTipoProd  = Ext.create('tiendarepuestos.store.TipoDeProductos');
        Ext.apply(me,{
            items:[
