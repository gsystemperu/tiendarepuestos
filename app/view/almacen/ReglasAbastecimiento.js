Ext.define('tiendarepuestos.view.almacen.ReglasAbastecimiento', {
  ...
  initComponent: function () {
    var storeAbastecimiento = Ext.create('tiendarepuestos.store.Abastecimientos');
    var storeProveedores = Ext.create('tiendarepuestos.store.Proveedores');
    var storeAbastecimientoDet = Ext.create('tiendarepuestos.store.AbastecimientoDetalle');
