Ext.define('tiendarepuestos.view.almacen.ProductoBuscarOC', {
    ...
    initComponent:function(){
        me = this;
        storeProducto  = Ext.create('tiendarepuestos.store.ProductosOrdenCompra');
        storeProducto.load({
          params:{
            idprov : me.getProveedor()
          }
        });
        storeTipoProd  = null; //Ext.create('tiendarepuestos.store.TipoDeProductos');
        Ext.apply(me,{
            items:[
