...
Ext.define('tiendarepuestos.view.almacen.ProductoUbicacion', {
    extend: 'Ext.window.Window',
    xtype:'wProductoUbicacion',
    requires:['tiendarepuestos.view.almacen.AccionesUbicacion'],
    modal:true,
    ...
    getItems:function(codigoserie){
      storeA = Ext.create('tiendarepuestos.store.Almacenes');
      storeS = Ext.create('tiendarepuestos.store.AlmacenSecciones');
      return obj = [
        {
            xtype: 'container',
            scrollable: true,
