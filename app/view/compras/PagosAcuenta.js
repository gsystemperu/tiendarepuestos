Ext.define('tiendarepuestos.view.compras.PagosAcuenta', {
    ...
    requires   : [
        ...
        'Ext.grid.*',
        'tiendarepuestos.view.compras.AccionesPagosAcuenta'
    ...
    initComponent: function()
    {
        ...
        Ext.Ajax.request({
              url : tiendarepuestos.util.Rutas.ordenCompraBuscarPagoAcuenta,
              params:{
