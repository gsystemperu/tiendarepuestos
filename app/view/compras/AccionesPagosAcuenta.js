Ext.define('tiendarepuestos.view.compras.AccionesPagosAcuenta', {
    ...
    onClickGuardarPagoAcuenta:function(btn){
      ...
      if(__store){
        ...
        Ext.Ajax.request({
            url :tiendarepuestos.util.Rutas.ordenCompraIngresarPagoAcuenta,
            params:{
            ...
            success:function(response){
                  ...
                  if(__data.error!=0){
                    tiendarepuestos.util.Util.showToast('Registrado');
                    __view.close();
