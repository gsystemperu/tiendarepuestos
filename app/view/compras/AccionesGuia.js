Ext.define('tiendarepuestos.view.compras.AccionesGuia', {
    ...
    {   me = this;
        if(record){
          me.lookupReference('dgvOrdenCompraConfirDetalle').mask('..cargando');
           ...
           Ext.Ajax.request({
               url : tiendarepuestos.util.Rutas.OrdenCompraConfirmadaDetalle,
               params:{
                 id :  record.get('id')
               },
               success:function(response){
                  _data = tiendarepuestos.util.Util.decodeJSON(response.responseText);
     ...
     ********************************************/
     ...
     onClickEliminarGuiaEntrada:function(btn){
       ...
       if(__record){
           Ext.Ajax.request({
               url : tiendarepuestos.util.Rutas.ordenCompraAnularConfirmado,
               params:{
                 id : __record.get('id')
               },
               success:function(response){
