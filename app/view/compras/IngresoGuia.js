Ext.define('tiendarepuestos.view.compras.IngresoGuia', {
  ...
  initComponent: function () {
    var storeOrdenCompraConfirmdaDet = Ext.create('tiendarepuestos.store.TmpOrdenCompraConfirmadas');
  ...
  getDatosDelProveedor: function () {
    return obj = {
      ...
      url: tiendarepuestos.util.Rutas.guiaProveedorGuardar,
      layout: 'hbox',
      padding: 5,
      bodyPadding: 5,
      defaults: {
