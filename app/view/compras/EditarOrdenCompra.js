Ext.define('tiendarepuestos.view.compras.EditarOrdenCompra', {
    extend: 'Ext.panel.Panel',
    xtype: 'weditarordencompra',
    requires: [
        'Ext.grid.plugin.*',
        'tiendarepuestos.view.compras.AccionesOrdenCompraEditar',
    ...
    initComponent: function () {
        ...
        var storeDetalle = Ext.create('tiendarepuestos.store.DetalleOrdenCompra');
            ...
            items: [
                {
                    ...
                    url: tiendarepuestos.util.Rutas.ordenCompraEditar,
                    items: [{
                            xtype: 'panel',
                            flex: 1,
                            frame: false,
