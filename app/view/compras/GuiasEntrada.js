Ext.define('tiendarepuestos.view.compras.GuiasEntrada', {
  ...
  requires: [
    ...
    'tiendarepuestos.view.compras.AccionesGuia',
    'Ext.grid.plugin.*'
  ],
  layout: {
    type: 'vbox',
  ...
  initComponent: function () {
    var storeOrdenCompraConfirmada = Ext.create('tiendarepuestos.store.OrdenesCompraConfirmadas');
    var storeProveedores = Ext.create('tiendarepuestos.store.Proveedores');
    var storeOrdenCompraConfirmdaDet = Ext.create('tiendarepuestos.store.DetalleIngresoGuiaVista');
  ...
  getPanelToolBarAbastecimiento: function (storeProveedores) {
    return obj = {
      ...
      items: [{
          ...
          xtype: 'button',
          glyph: tiendarepuestos.util.Glyphs.getGlyph(
            'buscar'),
