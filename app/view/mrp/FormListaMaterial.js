Ext.define('tiendarepuestos.view.mrp.FormListaMaterial', {
    ...
    requires   : [
        ...
        'tiendarepuestos.view.mrp.AccionesFormListaMaterial',
    ...
    getFormularioProducto: function (storeUnidadMedida, storeProveedores,storeProducto) {
      _storeDetListaMateriales = Ext.create('tiendarepuestos.store.DetListaMateriales', {});
      storeProducto.load();
      var obj = [
        {
          xtype:'hiddenfield',
