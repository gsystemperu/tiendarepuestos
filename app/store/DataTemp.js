Ext.define('tiendarepuestos.store.DataTemp', {
...
Ext.define('tiendarepuestos.store.TipoDocumento', {
    extend: 'Ext.data.Store',
    fields: ["id", "descripcion"],
    data: [
...
Ext.define('tiendarepuestos.store.DetalleAbastecimiento', {
    extend: 'Ext.data.Store',
    fields: [
...
Ext.define('tiendarepuestos.store.DetalleOrdenCompra', {
    extend: 'Ext.data.Store',
    fields: [
            {name: "idprod", type:'int' },
            {name: "producto", type:'string' },
 ...
 */
Ext.define('tiendarepuestos.store.TmpOrdenCompraConfirmadas', {
    extend: 'Ext.data.Store',
    fields: [
...
Ext.define('tiendarepuestos.store.DetProductoProveedor', {
    extend: 'Ext.data.Store',
    fields: [
            {name: "razonsocial"},
            {name: "precio", type:'float' }
...
Ext.define('tiendarepuestos.store.PagosAcuenta', {
    extend: 'Ext.data.Store',
    fields: [
...
Ext.define('tiendarepuestos.store.CajaDetalleVenta', {
    extend: 'Ext.data.Store',
    fields: [
      {name: "idprod", type:'int' },
      {name: "producto", type:'string' },
...
Ext.define('tiendarepuestos.store.GuiaRemisionDetalle', {
    extend: 'Ext.data.Store',
    fields: [
...
Ext.define('tiendarepuestos.store.DetListaMateriales', {
    extend: 'Ext.data.Store',
    fields: [
            {name: "producto"},
            {name: "cantidad", type:'float' },
...
Ext.define('tiendarepuestos.store.BusquedaEstado', {
    extend: 'Ext.data.Store',
    fields: [
